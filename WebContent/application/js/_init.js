...
//----------------------------------
var appliname = 'EPF';
var karutaname = 'EPF'; // to share the same 'karuta-core' with multiple front-end
...
navbar_title["en"] = "<img src='"+karuta_url+"/application/img/karuta-navbar.jpg'/>";
//-----------LOGIN PAGE -----------------------
var welcome1 = {};// Welcome title
	welcome1["fr"] = "<img class='img-responsive' src='"+karuta_url+"/application/img/logofonbleu.jpg'/>";
	welcome1["en"] = "<img class='img-responsive' src='"+karuta_url+"/application/img/logofonbleu.jpg'/>";
...
var welcome = {};// Welcome title
	welcome["fr"] = "<img class='img-responsive' src='"+karuta_url+"/application/img/logofonbleu.jpg'/>";
	welcome["en"] = "<img class='img-responsive' src='"+karuta_url+"/application/img/logofonbleu.jpg'/>";
//--------- PUBLIC EMAIL LOGO - MESSAGE -------
var url = window.location.href;
var serverURL = url.substring(0,url.indexOf(appliname)-1);
var g_sendEmailPublicURL_logo = serverURL+"/karuta/application/img/logofonbleu.jpg";
